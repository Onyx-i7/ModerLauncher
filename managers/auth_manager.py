...
class AuthManager:
    def __init__(self):
        ...
        self.auth_file = os.path.join(self.appdata, '.moderlauncher', 'launcher_accounts.json')
        self.user_file = os.path.join(self.appdata, '.moderlauncher', 'launcher_user.json')
        self.user_data_file = os.path.join(self.appdata, '.moderlauncher', 'user_data.json')
