...
class AuthManager:
    def __init__(self):
        ...
        self.auth_file = os.path.join(self.appdata, '.minecraft', 'launcher_accounts.json')
        self.user_file = os.path.join(self.appdata, '.minecraft', 'launcher_user.json')
        self.user_data_file = os.path.join(self.appdata, '.minecraft', 'user_data.json')
        ...
        try:
            ...
            if current_account:
                ...
                return {
                    ...
                    "clientToken": current_account.get("clientToken", str(uuid.uuid4())),
    ...
    def authenticate_offline(self, username, uuid):
        ...
        try:
            ...
            self.accounts["accounts"] = {uuid: account_data}
            self.save_accounts()
